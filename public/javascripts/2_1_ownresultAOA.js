...
var ownbase = L.tileLayer('http://{s}.tile.osm.org/{z}/{x}/{y}.png', 
    {
    attribution: '<a href="https://www.maptiler.com/copyright/" target="_blank">&copy; MapTiler</a> <a href="https://www.openstreetmap.org/copyright" target="_blank">&copy; OpenStreetMap contributors</a>'
    })

// create map for demo calculation results
var ownresultmap = L.map('ownresultmap', {center: [50.943144, 10.388001], zoom: 6, layers: ownbase});

// declare basemap and overlaymaps
var ownbaseMap = {"Basemap": ownbase};
var ownoverlayMaps;
...
function createSamplingLayer(samplinglayer){
    ownoverlayMaps = {"Recommended sampling areas": samplinglayer}
    L.control.layers(ownbaseMap,ownoverlayMaps).addTo(ownresultmap)
}
...
function createPredictionLayer(predictionlayer){
    ownoverlayMaps = {"Prediction": predictionlayer}
    L.control.layers(ownbaseMap,ownoverlayMaps).addTo(ownresultmap)
}
...
// set view to AOI
ownresultmap.fitBounds(coordsAOI)
