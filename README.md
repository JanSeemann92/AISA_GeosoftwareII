...
### Docker Hub
The frontend and backend container are also available in the aisa_cloud_vision repository on [Docker Hub](https://hub.docker.com/r/antonia123/aisa_cloud_vision):
