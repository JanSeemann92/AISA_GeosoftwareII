...
### Docker Hub
The frontend and backend container are also available in the aisa_cloud_vision repository on [Docker Hub](https://hub.docker.com/repository/docker/antonia123/aisa_cloud_vision):
